...
let talk = document.getElementById('startListener');
let buttonSay = document.getElementById('startText');
let inputSay = document.getElementById('textInput');
...
function startText(event) {
    ...
    if (volume > 10) {
        ...
        if (results.includes("Hola")) {
        ...
        }else if (results.includes("Cuanto es")) {
            let response = results.slice(9, 20);
            if (response.includes("?")) {
                message = "No se pueden usar simbolos como el simbolo de pregunta despues de la cuenta";
                var tts = new SpeechSynthesisUtterance(message);
                tts.pitch = 1.0;
                tts.rate = 1.0;
                tts.lang = "es-AR";
            ...
            message = "Espero que sea de tu agrado";
            var tts = new SpeechSynthesisUtterance(message);
            tts.pitch = 1.0;
            tts.rate = 1.0;
            tts.lang = "es-AR";
